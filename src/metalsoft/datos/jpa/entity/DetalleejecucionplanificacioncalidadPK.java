...
public class DetalleejecucionplanificacioncalidadPK implements Serializable {
    ...
    public String toString() {
        return "metalsoft.datos.jpa.entity.DetalleejecucionplanificacioncalidadPK[iddetalle=" + iddetalle + ", idejecucionplanificacioncalidad=" + idejecucionplanificacioncalidad + ", idplanificacioncalidad=" + idplanificacioncalidad + "]";
    }
