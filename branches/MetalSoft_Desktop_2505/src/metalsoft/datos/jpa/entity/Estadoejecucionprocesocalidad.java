...
public class Estadoejecucionprocesocalidad implements Serializable {
    ...
    private List<Ejecucionprocesocalidad> ejecucionprocesocalidadList;
    ...
    public List<Ejecucionprocesocalidad> getEjecucionprocesocalidadList() {
        return ejecucionprocesocalidadList;
    }

    public void setEjecucionprocesocalidadList(List<Ejecucionprocesocalidad> ejecucionprocesocalidadList) {
