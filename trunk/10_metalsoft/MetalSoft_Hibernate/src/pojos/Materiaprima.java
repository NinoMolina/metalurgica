...
public class Materiaprima  implements java.io.Serializable {
     ...
     private Set<Detallempasignada> detallempasignadas = new HashSet<Detallempasignada>(0);
    ...
    public Materiaprima(long idmateriaprima, Codigodebarra codigodebarra, Unidadmedida unidadmedida, Tipomaterial tipomaterial, String nombre, Date fechaalta, Date fechabaja, Long stock, String descripcion, BigDecimal alto, BigDecimal largo, BigDecimal ancho, String codproducto, Double precio, Long nromateriaprima, Set<Proveedorxmateriaprima> proveedorxmateriaprimas, Set<Detallecompra> detallecompras, Set<Matriz> matrizs, Set<Detallempasignada> detallempasignadas, Set<Detallerequerimientosmateriaprima> detallerequerimientosmateriaprimas, Set<Detalleproductopresupuesto> detalleproductopresupuestos, Set<Pieza> piezas) {
       this.idmateriaprima = idmateriaprima;
       ...
       this.detallempasignadas = detallempasignadas;
    ...
    public Set<Detallempasignada> getDetallempasignadas() {
        return this.detallempasignadas;
    }
    
    public void setDetallempasignadas(Set<Detallempasignada> detallempasignadas) {
        this.detallempasignadas = detallempasignadas;
    }
