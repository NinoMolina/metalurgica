...
public class Maquina  implements java.io.Serializable {
    ...
    public Maquina(long idmaquina, Marca marca, Estadomaquina estadomaquina, Tipomaquina tipomaquina, Unidadmedida unidadmedida, String nombre, String descripcion, Date fechaalta, Date fechabaja, Date tiempocapacidadproduccion) {
       this.idmaquina = idmaquina;
       this.marca = marca;
