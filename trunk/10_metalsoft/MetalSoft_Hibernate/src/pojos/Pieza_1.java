 ...
 */
public class Pieza_1  implements java.io.Serializable {
    ...
    public Pieza_1(long idpieza) {
        this.idpieza = idpieza;
    }
    public Pieza_1(long idpieza, Materiaprima materiaprima, Matriz matriz, Unidadmedida unidadmedida, String nombre, Long tipomaterial, BigDecimal alto, BigDecimal ancho, BigDecimal largo, Set<Detalleplanificacionproduccion> detalleplanificacionproduccions) {
       this.idpieza = idpieza;
