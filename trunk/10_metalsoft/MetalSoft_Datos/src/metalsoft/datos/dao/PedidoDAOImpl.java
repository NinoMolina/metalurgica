	...
	public int update(PedidoPK pedidopk, Pedido pedido, Connection con)throws PedidoException{
		...
		try
		{
			ps = con.prepareStatement("update PEDIDO set NROPEDIDO = ? , FECHACONFIRMACIONPEDIDO = ? , FECHAENTREGAESTIPULADA = ? , FECHAPEDIDOCOTIZACION = ? , FECHACANCELACION = ? , FECHAENTREGAREAL = ? , PRIODIDAD = ? , ESTADO = ? , FACTURA = ? , PRESUPUESTO = ? , FECHAREQUERIDACOTIZACION = ? , PLANO = ? , MOTIVOCANCELACION = ? , ESPEDIDOWEB = ? , NROPEDIDOCOTIZACIONCLIENTE = ? , FECHAREGPEDCOTIZ = ? , CLIENTE = ? , PLANPROCEDIMIENTOS = ? , PLANREQUERIMIENTOSMATERIAPRIMA = ? , PLANPROCESOSCALIDAD = ?  where idpedido = ?");
				...
				ps.setLong(18,pedido.getPlanprocedimientos());
				ps.setLong(19,pedido.getPlanrequerimientosmateriaprima());
				ps.setLong(20,pedido.getPlanprocesoscalidad());
...
*/
	...
	public int insert(Pedido pedido ,Connection con)throws PedidoException {
		...
		try
		{
			ps = con.prepareStatement("insert into PEDIDO( NROPEDIDO, FECHACONFIRMACIONPEDIDO, FECHAENTREGAESTIPULADA, FECHAPEDIDOCOTIZACION, FECHACANCELACION, FECHAENTREGAREAL, PRIODIDAD, ESTADO, FACTURA, PRESUPUESTO, FECHAREQUERIDACOTIZACION, PLANO, MOTIVOCANCELACION, ESPEDIDOWEB, NROPEDIDOCOTIZACIONCLIENTE, FECHAREGPEDCOTIZ, IDPEDIDO, CLIENTE, PLANPROCEDIMIENTOS, PLANREQUERIMIENTOSMATERIAPRIMA, PLANPROCESOSCALIDAD) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,pedido.getNropedido());
				ps.setDate(2,pedido.getFechaconfirmacionpedido());
				ps.setDate(3,pedido.getFechaentregaestipulada());
				ps.setDate(4,pedido.getFechapedidocotizacion());
				...
				ps.setLong(19,pedido.getPlanprocedimientos());
				ps.setLong(20,pedido.getPlanrequerimientosmateriaprima());
				ps.setLong(21,pedido.getPlanprocesoscalidad());
...
*/
	...
	public Pedido findByPrimaryKey(long idpedido, Connection con) throws PedidoException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where idpedido = ?";
...
*/
	...
	public Pedido[] findByNropedido(long nropedido, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where nropedido = ? order by nropedido";
			try {
...
*/
	...
	public Pedido[] findByFechaconfirmacionpedido(Date fechaconfirmacionpedido, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fechaconfirmacionpedido = ? order by fechaconfirmacionpedido";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFechaentregaestipulada(Date fechaentregaestipulada, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fechaentregaestipulada = ? order by fechaentregaestipulada";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFechapedidocotizacion(Date fechapedidocotizacion, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fechapedidocotizacion = ? order by fechapedidocotizacion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFechacancelacion(Date fechacancelacion, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fechacancelacion = ? order by fechacancelacion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFechaentregareal(Date fechaentregareal, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fechaentregareal = ? order by fechaentregareal";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPriodidad(String priodidad, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where priodidad = ? order by priodidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByEstado(long estado, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where estado = ? order by estado";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFactura(long factura, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where factura = ? order by factura";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPresupuesto(long presupuesto, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where presupuesto = ? order by presupuesto";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFecharequeridacotizacion(Date fecharequeridacotizacion, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fecharequeridacotizacion = ? order by fecharequeridacotizacion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPlano(long plano, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where plano = ? order by plano";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByMotivocancelacion(String motivocancelacion, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where motivocancelacion = ? order by motivocancelacion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByEspedidoweb(boolean espedidoweb, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where espedidoweb = ? order by espedidoweb";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByNropedidocotizacioncliente(int nropedidocotizacioncliente, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where nropedidocotizacioncliente = ? order by nropedidocotizacioncliente";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByFecharegpedcotiz(Date fecharegpedcotiz, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where fecharegpedcotiz = ? order by fecharegpedcotiz";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByIdpedido(long idpedido, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where idpedido = ? order by idpedido";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					stmt.setLong( 1, idpedido );
					rs = stmt.executeQuery();
...
*/
	...
	public Pedido[] findByCliente(long cliente, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where cliente = ? order by cliente";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPlanprocedimientos(long planprocedimientos, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where planprocedimientos = ? order by planprocedimientos";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPlanrequerimientosmateriaprima(long planrequerimientosmateriaprima, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where planrequerimientosmateriaprima = ? order by planrequerimientosmateriaprima";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findByPlanprocesoscalidad(long planprocesoscalidad, Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido where planprocesoscalidad = ? order by planprocesoscalidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Pedido[] findAll( Connection con) throws PedidoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nropedido, fechaconfirmacionpedido, fechaentregaestipulada, fechapedidocotizacion, fechacancelacion, fechaentregareal, priodidad, estado, factura, presupuesto, fecharequeridacotizacion, plano, motivocancelacion, espedidoweb, nropedidocotizacioncliente, fecharegpedcotiz, idpedido, cliente, planprocedimientos, planrequerimientosmateriaprima, planprocesoscalidad from pedido";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
