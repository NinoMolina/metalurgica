...
*/
	...
	public int insert(Detalletrabajotercerizado detalletrabajotercerizado ,Connection con)throws DetalletrabajotercerizadoException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLETRABAJOTERCERIZADO( IDDETALLE, IDTRABAJOTERCERIZADO, MONTOPARCIAL, CANTIDAD, DESCRIPCION, FECHAENVIOREAL, FECHAENTREGAREAL, PIEZA, PROCESO, ESTADO) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				...
				ps.setLong(10,detalletrabajotercerizado.getEstado());
