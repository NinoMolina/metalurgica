...
*/
	...
	public int insert(Detallepedido detallepedido ,Connection con)throws DetallepedidoException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLEPEDIDO( IDDETALLE, IDPEDIDO, PRECIO, CANTIDAD, PRODUCTO) values (?, ?, ?, ?, ?)");
				ps.setLong(1,detallepedido.getIddetalle());
				ps.setLong(2,detallepedido.getIdpedido());
				ps.setDouble(3,detallepedido.getPrecio());
				ps.setInt(4,detallepedido.getCantidad());
				ps.setLong(5,detallepedido.getProducto());
