...
*/
	...
	public int update(DetallecompraPK detallecomprapk, Detallecompra detallecompra, Connection con)throws DetallecompraException{
		...
		try
		{
			ps = con.prepareStatement("update DETALLECOMPRA set CANTIDAD = ? , MATERIAPRIMA = ? , PRECIOHISTORICO = ? , FECHARECEPCIONPARCIAL = ?  where iddetalle = ? AND idcompra = ?");
				...
				ps.setLong(5,detallecomprapk.getIddetalle());
				ps.setLong(6,detallecomprapk.getIdcompra());
...
*/
	...
	public int insert(Detallecompra detallecompra ,Connection con)throws DetallecompraException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLECOMPRA( IDDETALLE, IDCOMPRA, CANTIDAD, MATERIAPRIMA, PRECIOHISTORICO, FECHARECEPCIONPARCIAL) values (?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detallecompra.getIddetalle());
				ps.setLong(2,detallecompra.getIdcompra());
				ps.setInt(3,detallecompra.getCantidad());
				ps.setLong(4,detallecompra.getMateriaprima());
				ps.setDouble(5,detallecompra.getPreciohistorico());
				ps.setDate(6,detallecompra.getFecharecepcionparcial());
...
*/
	...
	public Detallecompra findByPrimaryKey(long iddetalle, long idcompra, Connection con) throws DetallecompraException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where iddetalle = ? AND idcompra = ?";
...
*/
	...
	public Detallecompra[] findByIddetalle(long iddetalle, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where iddetalle = ? order by iddetalle";
			try {
...
*/
	...
	public Detallecompra[] findByIdcompra(long idcompra, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where idcompra = ? order by idcompra";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallecompra[] findByCantidad(int cantidad, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where cantidad = ? order by cantidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallecompra[] findByMateriaprima(long materiaprima, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where materiaprima = ? order by materiaprima";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallecompra[] findByPreciohistorico(double preciohistorico, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where preciohistorico = ? order by preciohistorico";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallecompra[] findByFecharecepcionparcial(Date fecharecepcionparcial, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra where fecharecepcionparcial = ? order by fecharecepcionparcial";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallecompra[] findAll( Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Detallecompra[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws DetallecompraException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select iddetalle, idcompra, cantidad, materiaprima, preciohistorico, fecharecepcionparcial from detallecompra";
