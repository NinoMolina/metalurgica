...
*/
	...
	public int insert(Ejecucionplanificacioncalidad ejecucionplanificacioncalidad ,Connection con)throws EjecucionplanificacioncalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into EJECUCIONPLANIFICACIONCALIDAD( IDEJECUCION, IDPLANIFICACIONCALIDAD, FECHAINICIO, FECHAFIN, HORAINICIO, HORAFIN, ESTADO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,ejecucionplanificacioncalidad.getIdejecucion());
				ps.setLong(2,ejecucionplanificacioncalidad.getIdplanificacioncalidad());
				ps.setDate(3,ejecucionplanificacioncalidad.getFechainicio());
				ps.setDate(4,ejecucionplanificacioncalidad.getFechafin());
				ps.setTime(5,ejecucionplanificacioncalidad.getHorainicio());
				ps.setTime(6,ejecucionplanificacioncalidad.getHorafin());
				ps.setLong(7,ejecucionplanificacioncalidad.getEstado());
...
*/
	...
	public Ejecucionplanificacioncalidad findByPrimaryKey(long idejecucion, long idplanificacioncalidad, Connection con) throws EjecucionplanificacioncalidadException{
...
*/
	...
	protected Ejecucionplanificacioncalidad fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Ejecucionplanificacioncalidad dto = new Ejecucionplanificacioncalidad();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Ejecucionplanificacioncalidad dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Ejecucionplanificacioncalidad[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Ejecucionplanificacioncalidad ret[] = new Ejecucionplanificacioncalidad[ resultList.size() ];
