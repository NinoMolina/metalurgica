...
*/
	...
	public int delete(EjecucionplanificacionproduccionPK ejecucionplanificacionproduccionpk , Connection con)throws EjecucionplanificacionproduccionException{
		...
		}catch(SQLException sqle) {throw new EjecucionplanificacionproduccionException(sqle);}
		catch(Exception e) {throw new EjecucionplanificacionproduccionException(e);}
	}
...
*/
	...
	public int insert(Ejecucionplanificacionproduccion ejecucionplanificacionproduccion ,Connection con)throws EjecucionplanificacionproduccionException {
		...
		try
		{
			ps = con.prepareStatement("insert into EJECUCIONPLANIFICACIONPRODUCCION( IDEJECUCION, IDPLANIFICACIONPRODUCCION, FECHAINICIO, FECHAFIN, HORAINICIO, HORAFIN, ESTADO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,ejecucionplanificacionproduccion.getIdejecucion());
				ps.setLong(2,ejecucionplanificacionproduccion.getIdplanificacionproduccion());
				ps.setDate(3,ejecucionplanificacionproduccion.getFechainicio());
				ps.setDate(4,ejecucionplanificacionproduccion.getFechafin());
				ps.setTime(5,ejecucionplanificacionproduccion.getHorainicio());
				ps.setTime(6,ejecucionplanificacionproduccion.getHorafin());
				ps.setLong(7,ejecucionplanificacionproduccion.getEstado());
