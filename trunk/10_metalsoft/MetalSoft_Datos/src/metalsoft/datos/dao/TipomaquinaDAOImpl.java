...
*/
	...
	public int insert(Tipomaquina tipomaquina ,Connection con)throws TipomaquinaException {
		...
		try
		{
			ps = con.prepareStatement("insert into TIPOMAQUINA( IDTIPOMAQUINA, NOMBRE, DESCRIPCION) values (?, ?, ?)");
				ps.setLong(1,tipomaquina.getIdtipomaquina());
				ps.setString(2,tipomaquina.getNombre());
				ps.setString(3,tipomaquina.getDescripcion());
...
*/
	...
	public Tipomaquina findByPrimaryKey(long idtipomaquina, Connection con) throws TipomaquinaException{
...
*/
	...
	protected Tipomaquina fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Tipomaquina dto = new Tipomaquina();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Tipomaquina dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Tipomaquina[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Tipomaquina ret[] = new Tipomaquina[ resultList.size() ];
