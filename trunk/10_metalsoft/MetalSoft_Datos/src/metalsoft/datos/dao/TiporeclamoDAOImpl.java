...
*/
	...
	public int insert(Tiporeclamo tiporeclamo ,Connection con)throws TiporeclamoException {
		...
		try
		{
			ps = con.prepareStatement("insert into TIPORECLAMO( IDTIPORECLAMO, NOMBRE, DESCRIPCION) values (?, ?, ?)");
				ps.setLong(1,tiporeclamo.getIdtiporeclamo());
				ps.setString(2,tiporeclamo.getNombre());
				ps.setString(3,tiporeclamo.getDescripcion());
