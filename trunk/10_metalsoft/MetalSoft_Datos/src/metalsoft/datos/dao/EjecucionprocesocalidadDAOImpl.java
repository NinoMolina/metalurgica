...
*/
	...
	public int update(EjecucionprocesocalidadPK ejecucionprocesocalidadpk, Ejecucionprocesocalidad ejecucionprocesocalidad, Connection con)throws EjecucionprocesocalidadException{
		...
		try
		{
			ps = con.prepareStatement("update EJECUCIONPROCESOCALIDAD set DURACIONREAL = ? , RESULTADO = ? , ESTADO = ?  where nroejecucion = ? AND idprocesocalidad = ?");
				...
				ps.setLong(4,ejecucionprocesocalidadpk.getNroejecucion());
				ps.setLong(5,ejecucionprocesocalidadpk.getIdprocesocalidad());
...
*/
	...
	public int insert(Ejecucionprocesocalidad ejecucionprocesocalidad ,Connection con)throws EjecucionprocesocalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into EJECUCIONPROCESOCALIDAD( NROEJECUCION, IDPROCESOCALIDAD, DURACIONREAL, RESULTADO, ESTADO) values (?, ?, ?, ?, ?)");
				...
				ps.setLong(5,ejecucionprocesocalidad.getEstado());
...
*/
	...
	public Ejecucionprocesocalidad findByPrimaryKey(long nroejecucion, long idprocesocalidad, Connection con) throws EjecucionprocesocalidadException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where nroejecucion = ? AND idprocesocalidad = ?";
...
*/
	...
	public Ejecucionprocesocalidad[] findByNroejecucion(long nroejecucion, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where nroejecucion = ? order by nroejecucion";
			try {
...
*/
	...
	public Ejecucionprocesocalidad[] findByIdprocesocalidad(long idprocesocalidad, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where idprocesocalidad = ? order by idprocesocalidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionprocesocalidad[] findByDuracionreal(Time duracionreal, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where duracionreal = ? order by duracionreal";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionprocesocalidad[] findByResultado(String resultado, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where resultado = ? order by resultado";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionprocesocalidad[] findByEstado(long estado, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad where estado = ? order by estado";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionprocesocalidad[] findAll( Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Ejecucionprocesocalidad[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws EjecucionprocesocalidadException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select nroejecucion, idprocesocalidad, duracionreal, resultado, estado from ejecucionprocesocalidad";
