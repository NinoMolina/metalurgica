...
*/
	...
	public int insert(Detallemantenimientocorrectivo detallemantenimientocorrectivo ,Connection con)throws DetallemantenimientocorrectivoException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLEMANTENIMIENTOCORRECTIVO( IDMANTENIMIENTOCORRECTIVO, IDDETALLE, DURACION, ROTURA, MOTIVOROTURA) values (?, ?, ?, ?, ?)");
				ps.setLong(1,detallemantenimientocorrectivo.getIdmantenimientocorrectivo());
				ps.setLong(2,detallemantenimientocorrectivo.getIddetalle());
				ps.setTime(3,detallemantenimientocorrectivo.getDuracion());
				ps.setLong(4,detallemantenimientocorrectivo.getRotura());
				ps.setString(5,detallemantenimientocorrectivo.getMotivorotura());
...
*/
	...
	public Detallemantenimientocorrectivo findByPrimaryKey(long idmantenimientocorrectivo, long iddetalle, Connection con) throws DetallemantenimientocorrectivoException{
...
*/
	...
	protected Detallemantenimientocorrectivo fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Detallemantenimientocorrectivo dto = new Detallemantenimientocorrectivo();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Detallemantenimientocorrectivo dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Detallemantenimientocorrectivo[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Detallemantenimientocorrectivo ret[] = new Detallemantenimientocorrectivo[ resultList.size() ];
