...
*/
	...
	public int insert(Detallerequerimientosmateriaprima detallerequerimientosmateriaprima ,Connection con)throws DetallerequerimientosmateriaprimaException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLEREQUERIMIENTOSMATERIAPRIMA( IDDETALLE, IDPLANREQUERIMIENTOSMATERIAPRIMA, CANTIDADMATERIAPRIMA, IDPIEZA, IDMATERIAPRIMA) values (?, ?, ?, ?, ?)");
				ps.setLong(1,detallerequerimientosmateriaprima.getIddetalle());
				ps.setLong(2,detallerequerimientosmateriaprima.getIdplanrequerimientosmateriaprima());
				ps.setInt(3,detallerequerimientosmateriaprima.getCantidadmateriaprima());
				ps.setLong(4,detallerequerimientosmateriaprima.getIdpieza());
				ps.setLong(5,detallerequerimientosmateriaprima.getIdmateriaprima());
