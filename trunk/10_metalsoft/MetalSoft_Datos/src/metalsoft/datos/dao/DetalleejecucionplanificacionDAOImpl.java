...
*/
	...
	public int insert(Detalleejecucionplanificacion detalleejecucionplanificacion ,Connection con)throws DetalleejecucionplanificacionException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLEEJECUCIONPLANIFICACION( IDDETALLE, IDEJECUCIONPLANIFICACIONPRODUCCION, PIEZA, EJECUCIONETAPA, IDPLANIFICACIONPRODUCCION, IDETAPAPRODUCCION, PIEZAREAL) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detalleejecucionplanificacion.getIddetalle());
				ps.setLong(2,detalleejecucionplanificacion.getIdejecucionplanificacionproduccion());
				ps.setLong(3,detalleejecucionplanificacion.getPieza());
				ps.setLong(4,detalleejecucionplanificacion.getEjecucionetapa());
				ps.setLong(5,detalleejecucionplanificacion.getIdplanificacionproduccion());
				ps.setLong(6,detalleejecucionplanificacion.getIdetapaproduccion());
				ps.setLong(7,detalleejecucionplanificacion.getPiezareal());
