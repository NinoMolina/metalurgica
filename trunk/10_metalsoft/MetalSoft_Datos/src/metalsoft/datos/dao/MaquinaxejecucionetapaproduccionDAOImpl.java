...
* Date of code generation: Mon Jun 14 23:39:19 GYT 2010
*
...
*/
	...
	public Maquinaxejecucionetapaproduccion findByPrimaryKey(long idejecucionetapaproduccion, long idetapaproduccion, long idmaquina, Connection con) throws MaquinaxejecucionetapaproduccionException{
...
*/
	...
	protected Maquinaxejecucionetapaproduccion fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Maquinaxejecucionetapaproduccion dto = new Maquinaxejecucionetapaproduccion();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Maquinaxejecucionetapaproduccion dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Maquinaxejecucionetapaproduccion[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Maquinaxejecucionetapaproduccion ret[] = new Maquinaxejecucionetapaproduccion[ resultList.size() ];
