...
*/
	...
	public int insert(Reclamocliente reclamocliente ,Connection con)throws ReclamoclienteException {
		...
		try
		{
			ps = con.prepareStatement("insert into RECLAMOCLIENTE( IDRECLAMO, NRORECLAMO, TIPORECLAMO, MOTIVO, FECHARECLAMO, CLIENTE) values (?, ?, ?, ?, ?, ?)");
				ps.setLong(1,reclamocliente.getIdreclamo());
				ps.setLong(2,reclamocliente.getNroreclamo());
				ps.setLong(3,reclamocliente.getTiporeclamo());
				ps.setString(4,reclamocliente.getMotivo());
				ps.setDate(5,reclamocliente.getFechareclamo());
				ps.setLong(6,reclamocliente.getCliente());
...
*/
	...
	public Reclamocliente findByPrimaryKey(long idreclamo, Connection con) throws ReclamoclienteException{
...
*/
	...
	protected Reclamocliente fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Reclamocliente dto = new Reclamocliente();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Reclamocliente dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Reclamocliente[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Reclamocliente ret[] = new Reclamocliente[ resultList.size() ];
