...
*/
	...
	public int insert(Detallereclamoempresametalurgica detallereclamoempresametalurgica ,Connection con)throws DetallereclamoempresametalurgicaException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLERECLAMOEMPRESAMETALURGICA( IDDETALLE, IDRECLAMO, CANTIDAD, DESCRIPCION, MOTIVO, PIEZA, FECHAEGRESO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detallereclamoempresametalurgica.getIddetalle());
				ps.setLong(2,detallereclamoempresametalurgica.getIdreclamo());
				ps.setInt(3,detallereclamoempresametalurgica.getCantidad());
				ps.setString(4,detallereclamoempresametalurgica.getDescripcion());
				ps.setString(5,detallereclamoempresametalurgica.getMotivo());
				ps.setLong(6,detallereclamoempresametalurgica.getPieza());
				ps.setDate(7,detallereclamoempresametalurgica.getFechaegreso());
