...
*/
	...
	public int insert(Empresametalurgica empresametalurgica ,Connection con)throws EmpresametalurgicaException {
		...
		try
		{
			ps = con.prepareStatement("insert into EMPRESAMETALURGICA( IDEMPRESAMETALURGICA, NROEMPRESAMETALURGICA, RAZONSOCIAL, RESPONSABLE, TELEFONO, CELULAR, MAIL, DOMICILIO, FECHAALTA, FECHABAJA, CUIL, CONDICIONIVA, CUIT) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,empresametalurgica.getIdempresametalurgica());
				ps.setLong(2,empresametalurgica.getNroempresametalurgica());
				ps.setString(3,empresametalurgica.getRazonsocial());
				ps.setLong(4,empresametalurgica.getResponsable());
				ps.setString(5,empresametalurgica.getTelefono());
				ps.setString(6,empresametalurgica.getCelular());
				ps.setString(7,empresametalurgica.getMail());
				ps.setLong(8,empresametalurgica.getDomicilio());
				ps.setDate(9,empresametalurgica.getFechaalta());
				ps.setDate(10,empresametalurgica.getFechabaja());
				ps.setString(11,empresametalurgica.getCuil());
				ps.setLong(12,empresametalurgica.getCondicioniva());
				ps.setString(13,empresametalurgica.getCuit());
