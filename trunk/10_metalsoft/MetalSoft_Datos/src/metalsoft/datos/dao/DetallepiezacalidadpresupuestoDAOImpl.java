...
*/
	...
	public Detallepiezacalidadpresupuesto findByPrimaryKey(long iddetalle, Connection con) throws DetallepiezacalidadpresupuestoException{
...
*/
	...
	protected Detallepiezacalidadpresupuesto fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Detallepiezacalidadpresupuesto dto = new Detallepiezacalidadpresupuesto();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Detallepiezacalidadpresupuesto dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Detallepiezacalidadpresupuesto[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Detallepiezacalidadpresupuesto ret[] = new Detallepiezacalidadpresupuesto[ resultList.size() ];
