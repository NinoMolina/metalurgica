...
*/
	...
	public int insert(Domicilio domicilio ,Connection con)throws DomicilioException {
		...
		try
		{
			ps = con.prepareStatement("insert into DOMICILIO( IDDOMICILIO, CALLE, NUMEROCALLE, PISO, DEPTO, TORRE, BARRIO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,domicilio.getIddomicilio());
				ps.setString(2,domicilio.getCalle());
				ps.setInt(3,domicilio.getNumerocalle());
				ps.setInt(4,domicilio.getPiso());
				ps.setString(5,domicilio.getDepto());
				ps.setString(6,domicilio.getTorre());
				ps.setLong(7,domicilio.getBarrio());
