...
*/
	...
	public int delete(EjecucionetapaproduccionPK ejecucionetapaproduccionpk , Connection con)throws EjecucionetapaproduccionException{
		...
		try {
			ps = con.prepareStatement("delete from  EJECUCIONETAPAPRODUCCION where nroejecucion = ? AND idetapaproduccion = ?");
			ps.setLong(1, ejecucionetapaproduccionpk.getNroejecucion());
...
*/
	...
	public int update(EjecucionetapaproduccionPK ejecucionetapaproduccionpk, Ejecucionetapaproduccion ejecucionetapaproduccion, Connection con)throws EjecucionetapaproduccionException{
		...
		try
		{
			ps = con.prepareStatement("update EJECUCIONETAPAPRODUCCION set NOMBRE = ? , TOTALHORASMAQUINA = ? , TOTALHORASHOMBRE = ? , EMPLEADO = ? , FECHAINICIO = ? , HORAINICIO = ? , FECHAFIN = ? , HORAFIN = ? , OBSERVACIONES = ? , ESTADO = ?  where nroejecucion = ? AND idetapaproduccion = ?");
				...
				ps.setLong(11,ejecucionetapaproduccionpk.getNroejecucion());
				ps.setLong(12,ejecucionetapaproduccionpk.getIdetapaproduccion());
...
*/
	...
	public int insert(Ejecucionetapaproduccion ejecucionetapaproduccion ,Connection con)throws EjecucionetapaproduccionException {
		...
		try
		{
			ps = con.prepareStatement("insert into EJECUCIONETAPAPRODUCCION( NROEJECUCION, IDETAPAPRODUCCION, NOMBRE, TOTALHORASMAQUINA, TOTALHORASHOMBRE, EMPLEADO, FECHAINICIO, HORAINICIO, FECHAFIN, HORAFIN, OBSERVACIONES, ESTADO) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,ejecucionetapaproduccion.getNroejecucion());
				ps.setLong(2,ejecucionetapaproduccion.getIdetapaproduccion());
				ps.setString(3,ejecucionetapaproduccion.getNombre());
				ps.setTime(4,ejecucionetapaproduccion.getTotalhorasmaquina());
				ps.setTime(5,ejecucionetapaproduccion.getTotalhorashombre());
				ps.setLong(6,ejecucionetapaproduccion.getEmpleado());
				ps.setDate(7,ejecucionetapaproduccion.getFechainicio());
				ps.setTime(8,ejecucionetapaproduccion.getHorainicio());
				ps.setDate(9,ejecucionetapaproduccion.getFechafin());
				ps.setTime(10,ejecucionetapaproduccion.getHorafin());
				ps.setString(11,ejecucionetapaproduccion.getObservaciones());
				ps.setLong(12,ejecucionetapaproduccion.getEstado());
...
*/
	...
	public Ejecucionetapaproduccion findByPrimaryKey(long nroejecucion, long idetapaproduccion, Connection con) throws EjecucionetapaproduccionException{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where nroejecucion = ? AND idetapaproduccion = ?";
...
*/
	...
	public Ejecucionetapaproduccion findByPrimaryKey(EjecucionetapaproduccionPK ejecucionetapaproduccionpk, Connection con) throws EjecucionetapaproduccionException{
		return findByPrimaryKey(ejecucionetapaproduccionpk.getNroejecucion(), ejecucionetapaproduccionpk.getIdetapaproduccion(), con);
	}
...
*/
	...
	public Ejecucionetapaproduccion[] findByNroejecucion(long nroejecucion, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where nroejecucion = ? order by nroejecucion";
			try {
...
*/
	...
	public Ejecucionetapaproduccion[] findByIdetapaproduccion(long idetapaproduccion, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where idetapaproduccion = ? order by idetapaproduccion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByNombre(String nombre, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where nombre = ? order by nombre";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByTotalhorasmaquina(Time totalhorasmaquina, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where totalhorasmaquina = ? order by totalhorasmaquina";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByTotalhorashombre(Time totalhorashombre, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where totalhorashombre = ? order by totalhorashombre";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByEmpleado(long empleado, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where empleado = ? order by empleado";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByFechainicio(Date fechainicio, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where fechainicio = ? order by fechainicio";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByHorainicio(Time horainicio, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where horainicio = ? order by horainicio";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByFechafin(Date fechafin, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where fechafin = ? order by fechafin";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByHorafin(Time horafin, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where horafin = ? order by horafin";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByObservaciones(String observaciones, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where observaciones = ? order by observaciones";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findByEstado(long estado, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion where estado = ? order by estado";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Ejecucionetapaproduccion[] findAll( Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Ejecucionetapaproduccion[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws EjecucionetapaproduccionException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select nroejecucion, idetapaproduccion, nombre, totalhorasmaquina, totalhorashombre, empleado, fechainicio, horainicio, fechafin, horafin, observaciones, estado from ejecucionetapaproduccion";
