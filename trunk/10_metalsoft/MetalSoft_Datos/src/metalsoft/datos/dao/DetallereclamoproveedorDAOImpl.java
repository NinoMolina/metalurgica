...
*/
	...
	public int update(DetallereclamoproveedorPK detallereclamoproveedorpk, Detallereclamoproveedor detallereclamoproveedor, Connection con)throws DetallereclamoproveedorException{
		...
		try
		{
			ps = con.prepareStatement("update DETALLERECLAMOPROVEEDOR set CANTIDAD = ? , DESCRIPCION = ? , MOTIVO = ? , MATERIAPRIMA = ? , FECHAEGRESO = ?  where iddetalle = ? AND idreclamo = ?");
				...
				ps.setLong(4,detallereclamoproveedor.getMateriaprima());
				ps.setDate(5,detallereclamoproveedor.getFechaegreso());
				ps.setLong(6,detallereclamoproveedorpk.getIddetalle());
				ps.setLong(7,detallereclamoproveedorpk.getIdreclamo());
...
*/
	...
	public int insert(Detallereclamoproveedor detallereclamoproveedor ,Connection con)throws DetallereclamoproveedorException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLERECLAMOPROVEEDOR( IDDETALLE, IDRECLAMO, CANTIDAD, DESCRIPCION, MOTIVO, MATERIAPRIMA, FECHAEGRESO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detallereclamoproveedor.getIddetalle());
				ps.setLong(2,detallereclamoproveedor.getIdreclamo());
				ps.setInt(3,detallereclamoproveedor.getCantidad());
				ps.setString(4,detallereclamoproveedor.getDescripcion());
				ps.setString(5,detallereclamoproveedor.getMotivo());
				ps.setLong(6,detallereclamoproveedor.getMateriaprima());
				ps.setDate(7,detallereclamoproveedor.getFechaegreso());
...
*/
	...
	public Detallereclamoproveedor findByPrimaryKey(long iddetalle, long idreclamo, Connection con) throws DetallereclamoproveedorException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where iddetalle = ? AND idreclamo = ?";
...
*/
	...
	public Detallereclamoproveedor[] findByIddetalle(long iddetalle, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where iddetalle = ? order by iddetalle";
			try {
...
*/
	...
	public Detallereclamoproveedor[] findByIdreclamo(long idreclamo, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where idreclamo = ? order by idreclamo";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallereclamoproveedor[] findByCantidad(int cantidad, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where cantidad = ? order by cantidad";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallereclamoproveedor[] findByDescripcion(String descripcion, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where descripcion = ? order by descripcion";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallereclamoproveedor[] findByMotivo(String motivo, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where motivo = ? order by motivo";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
/**
*
* Returns all rows from detallereclamoproveedor table where MATERIAPRIMA= materiaprima
*
...
*/
	...
	public Detallereclamoproveedor[] findByMateriaprima(long materiaprima, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where materiaprima = ? order by materiaprima";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallereclamoproveedor[] findByFechaegreso(Date fechaegreso, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor where fechaegreso = ? order by fechaegreso";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Detallereclamoproveedor[] findAll( Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Detallereclamoproveedor[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws DetallereclamoproveedorException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select iddetalle, idreclamo, cantidad, descripcion, motivo, materiaprima, fechaegreso from detallereclamoproveedor";
