...
*/
	...
	public int insert(Detallereclamoproveedor detallereclamoproveedor ,Connection con)throws DetallereclamoproveedorException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLERECLAMOPROVEEDOR( IDDETALLE, IDRECLAMO, CANTIDAD, DESCRIPCION, MOTIVO, IDDETALLECOMPRA, FECHAEGRESO, IDCOMPRA) values (?, ?, ?, ?, ?, ?, ?, ?)");
				...
				ps.setLong(6,detallereclamoproveedor.getIddetallecompra());
				ps.setDate(7,detallereclamoproveedor.getFechaegreso());
				ps.setLong(8,detallereclamoproveedor.getIdcompra());
