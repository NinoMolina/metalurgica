...
*/
	...
	public int insert(Presupuesto presupuesto ,Connection con)throws PresupuestoException {
		...
		try
		{
			ps = con.prepareStatement("insert into PRESUPUESTO( IDPRESUPUESTO, FECHAPRESUPUESTO, MONTOTOTAL, FECHAVENCIMIENTO) values (?, ?, ?, ?)");
				ps.setLong(1,presupuesto.getIdpresupuesto());
				ps.setDate(2,presupuesto.getFechapresupuesto());
				ps.setDouble(3,presupuesto.getMontototal());
				ps.setDate(4,presupuesto.getFechavencimiento());
