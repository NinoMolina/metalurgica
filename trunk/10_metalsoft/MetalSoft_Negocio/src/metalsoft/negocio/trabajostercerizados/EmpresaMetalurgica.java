...
import metalsoft.sistema.compras.PersonaJuridica;
...
public class EmpresaMetalurgica extends PersonaJuridica 
{
   ...
   /**
    * @roseuid 4BC24E46025F
    */
   public void conocerReaclamo() 
   {
    
   }
   
   /**
    * @roseuid 4C205DD6015A
    */
