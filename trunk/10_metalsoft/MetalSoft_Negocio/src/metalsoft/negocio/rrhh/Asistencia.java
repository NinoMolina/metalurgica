...
import metalsoft.datos.dbobject.AsistenciaPK;
...
public class Asistencia 
{
   ...
   private Empleado empleado;
    ...
    public static long update(AsistenciaDB asistencia, Connection cn) {
        ...
        AsistenciaPK pk=new AsistenciaPK(asistencia.getEmpleado(), asistencia.getFechaingreso(), asistencia.getHoraingreso());
        try {
