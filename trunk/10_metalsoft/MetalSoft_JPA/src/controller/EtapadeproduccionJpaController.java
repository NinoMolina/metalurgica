...
//            if (maquina != null) {
//                maquina.getEtapadeproduccionSet().add(etapadeproduccion);
...
//                maquinaOld.getEtapadeproduccionSet().remove(etapadeproduccion);
//                maquinaOld = em.merge(maquinaOld);
//            }
//            if (maquinaNew != null && !maquinaNew.equals(maquinaOld)) {
//                maquinaNew.getEtapadeproduccionSet().add(etapadeproduccion);
...
//            Maquina maquina = etapadeproduccion.getMaquina();
//            if (maquina != null) {
//                maquina.getEtapadeproduccionSet().remove(etapadeproduccion);
//                maquina = em.merge(maquina);
//            }
