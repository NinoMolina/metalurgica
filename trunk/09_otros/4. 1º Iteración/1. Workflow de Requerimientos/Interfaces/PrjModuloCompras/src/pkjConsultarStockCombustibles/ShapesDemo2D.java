...
final static Color red = Color.YELLOW;
...
int stringY = gridHeight - 3 - fontMetrics.getDescent();
 //stringY - fontMetrics.getMaxAscent() - y - 2;
// draw Line2D.Double
...
g2.setPaint(red);
g2.fill(new Arc2D.Double(x, y, rectWidth, rectHeight,200,(270-200)*2, Arc2D.OPEN));
g2.setPaint(fg);
