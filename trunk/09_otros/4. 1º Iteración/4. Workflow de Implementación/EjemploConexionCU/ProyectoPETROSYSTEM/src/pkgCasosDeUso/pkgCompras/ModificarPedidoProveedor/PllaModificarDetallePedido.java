/*
 * PllaModificarDetallePedido.java
 *
 * Created on 8 de junio de 2008, 23:30
 */
 ...
 * @author  Armando
 */
public class PllaModificarDetallePedido extends javax.swing.JFrame {
    
     private DefaultListModel lstModelProductos=new DefaultListModel();
    
    /** Creates new form PllaModificarDetallePedido */
    public PllaModificarDetallePedido() {
        initComponents();
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
     int opcion=Mensaje.mensaje_Consulta_YES_NO_OPTION("¿Está seguro que desea modificar los datos?");;
       if(opcion!=0){
         Mensaje.mensaje_Estandar("Modificación de Detalle Cancelada");  
         this.dispose();
         return;
       }
