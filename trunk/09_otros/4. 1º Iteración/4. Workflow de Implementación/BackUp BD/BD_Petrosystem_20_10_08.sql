...
CREATE TABLE `cliente` (
  ...
  `numeroCliente` int(10) unsigned default NULL,
  `mail` varchar(50) default NULL,
  `fk_Domicilio` int(10) unsigned default NULL,
  `fk_CondicionIva` int(10) unsigned default NULL,
  `fk_CtaCteCliente` int(10) unsigned default NULL,
  `fk_TipoCliente` int(10) unsigned default NULL,
...
INSERT INTO `cliente` (`Id_Cliente`,`numeroCliente`,`mail`,`fk_Domicilio`,`fk_CondicionIva`,`fk_CtaCteCliente`,`fk_TipoCliente`) VALUES 
 (10,10,'diegocohen55@hotmail.com',21,4,NULL,1),
 (11,11,'armandoln_ayala@hotmail.com',22,2,NULL,1),
 (12,12,'ferbornoroni@hotmail.com',23,2,NULL,1),
 (18,18,'johanna_v26@hotmail.com',29,1,NULL,2),
 (19,19,'pupi_4@hotmail.com',30,1,NULL,2),
 (20,20,'jocobocohen@hotmail.com',31,2,NULL,2),
 (21,21,'',32,2,NULL,1);
...
INSERT INTO `clienteempresa` (`Id_ClienteEmpresa`,`razonSocial`,`cuit`,`numIngresoBruto`,`fk_Cliente`) VALUES 
 (8,'DIEGO COHEN',12345678911,12345678911,10),
 (9,'ARMANDO AYALA',12345678912,12345678912,11),
 (10,'FERNANDO BORNORONI',78945612311,78945612311,12),
 (11,'HOTEL CARLOS PAZ',12378945611,12378945611,21);
...
CREATE TABLE `clienteparticular` (
  ...
  `fk_TipoDocumento` int(10) unsigned default NULL,
...
INSERT INTO `clienteparticular` (`Id_ClienteParticular`,`nombre`,`numeroDocumento`,`sexo`,`fechaNacimiento`,`fk_Cliente`,`fk_TipoDocumento`) VALUES 
 (2,'VACA JOHANNA',32314153,'FEMENINO','1988-04-23 00:00:00',18,3),
 (3,'CECILIA ANDURNO',32314154,'FEMENINO','1985-06-12 00:00:00',19,1),
 (4,'JACOBO COHEN',11296645,'MASCULINO','1956-08-21 00:00:00',20,1);
...
INSERT INTO `domicilio` (`Id_Domicilio`,`nombreCalle`,`nroCalle`,`departamento`,`nroPiso`,`barrio`,`fk_Ciudad`,`fk_Provincia`) VALUES 
 ...
 (21,'SARGENTO CABRAL',1809,'-',0,'SAN VICENTE',6,1),
 (22,'MAIPÚ',340,'B',5,'CENTRO',6,1),
 (23,'AV. COLON',785,'-',0,'CENTRO',6,1),
 (29,'CESAR CARRIZO',2605,'-',0,'POETA LUGONES',6,1),
 (30,'AV SABATTINI',1235,'-',0,'MAIPU',6,1),
 (31,'SARGENTO CABRAL',1809,'-',0,'SAN VICENTE',6,1),
 (32,'AV. CARCANO',1254,'-',0,'CENTRO',1,1);
...
INSERT INTO `producto` (`Id_Producto`,`nombre`,`precioCosto`,`precioVenta`,`stockMinimo`,`stockActual`,`unidad`,`autorizacionPedidoEnPlaya`,`fk_Iva`,`activo`) VALUES 
 ...
 (8,'NAFTA NORMAL',2.2,2.7,1000,9000,'Litros',0,1,1),
 (9,'KEROSENE',2.6,2.99,500,7000,'Litros',0,1,1),
 (10,'GASOIL',2.7,2.59,2000,20000,'Litros',0,1,1),
...
INSERT INTO `proveedor` (`Id_Proveedor`,`razonSocial`,`cuit`,`ingresoBruto`,`fk_CondicionIva`,`fk_Domicilio`,`fk_CuentaCorrienteProveedor`) VALUES 
 ...
 (6,'HIELERA SA',28765432112,28765432112,2,7,NULL),
...
INSERT INTO `telefonoxcliente` (`fk_Telefono`,`fk_Cliente`) VALUES 
 (92,10),
 (93,10),
 (94,11),
 (95,12),
...
CREATE TABLE `tipocliente` (
  `Id_TipoCliente` int(10) unsigned NOT NULL auto_increment,
...
INSERT INTO `tipocliente` (`Id_TipoCliente`,`nombre`) VALUES 
 (1,'Cliente Empresa'),
