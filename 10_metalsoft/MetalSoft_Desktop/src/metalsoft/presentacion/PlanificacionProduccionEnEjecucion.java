...
public class PlanificacionProduccionEnEjecucion extends javax.swing.JDialog {
    ...
    private void btnSeleccionarActionPerformed(ActionEvent e) {
        ...
        lblNroEjecucionPlanificacion.setText(NumerosAMostrar.getNumeroString(NumerosAMostrar.NRO_EJECUCION_PLANIFICACION, ep.getNroejecucionplanificacion().longValue()));
    ...
    class EnEjecucionTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                case 0:
                    return NumerosAMostrar.getNumeroString(NumerosAMostrar.NRO_EJECUCION_PLANIFICACION, view.getNroejecucionplanificacion().longValue());
                case 1:
