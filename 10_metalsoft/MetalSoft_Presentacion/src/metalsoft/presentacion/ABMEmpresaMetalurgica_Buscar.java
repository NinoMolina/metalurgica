 ...
 *
 * Created on 11/09/2010, 18:06:19
 */
...
public class ABMEmpresaMetalurgica_Buscar extends javax.swing.JFrame  implements IBuscador{
    ...
    private Timer timer;
    private EmpresaMetalurgicaDB[] empresaMetalurgicaDB;

    public EmpresaMetalurgicaDB[] getEmpresaMetalurgicaDB() {
        return empresaMetalurgicaDB;
    }

    public void setEmpresaMetalurgicaDB(EmpresaMetalurgicaDB[] empresaMetalurgicaDB) {
        this.empresaMetalurgicaDB = empresaMetalurgicaDB;
    }
    ...
    private void txtValorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtValorKeyReleased
        if(txtValor.getText().compareTo("")!=0) {
            ...
            timer.schedule(new TimerTask() {
                ...
                @Override
                public void run() {
                    hiloBuscarEmpresaMetalurgica=new HiloBuscarProveedor();
                    hiloBuscarEmpresaMetalurgica.setVentana(abm);
                    hiloBuscarEmpresaMetalurgica.setValor(txtValor.getText());
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        ventana.setIdEmpresaMetalurgica(id);
        ventana.empresaMetalurgicaSeleccionada();
