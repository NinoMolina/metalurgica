...
public class MaquinaxejecucionetapaproduccionPK implements Serializable {
    ...
    public String toString() {
        return "entity.MaquinaxejecucionetapaproduccionPK[idejecucionetapaproduccion=" + idejecucionetapaproduccion + ", idetapaproduccion=" + idetapaproduccion + ", idmaquina=" + idmaquina + "]";
    }
