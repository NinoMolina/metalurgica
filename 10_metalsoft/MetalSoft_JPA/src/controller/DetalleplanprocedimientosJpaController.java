...
public class DetalleplanprocedimientosJpaController {
    ...
    public void create(Detalleplanprocedimientos detalleplanprocedimientos) throws PreexistingEntityException, Exception {
        ...
        detalleplanprocedimientos.getDetalleplanprocedimientosPK().setIdplanpprocedimientos(detalleplanprocedimientos.getPlanprocedimientos1().getIdplanprocedimientos());
        ...
        try {
            ...
            Etapadeproduccion idetapaproduccion1 = detalleplanprocedimientos.getIdetapaproduccion1();
            if (idetapaproduccion1 != null) {
                ...
                detalleplanprocedimientos.setIdetapaproduccion1(idetapaproduccion1);
            }
            ...
            Planprocedimientos planprocedimientos1 = detalleplanprocedimientos.getPlanprocedimientos1();
            if (planprocedimientos1 != null) {
                ...
                detalleplanprocedimientos.setPlanprocedimientos1(planprocedimientos1);
            }
            ...
            if (idetapaproduccion1 != null) {
                idetapaproduccion1.getDetalleplanprocedimientosSet().add(detalleplanprocedimientos);
            ...
            if (planprocedimientos1 != null) {
                planprocedimientos1.getDetalleplanprocedimientosSet().add(detalleplanprocedimientos);
    ...
    public void edit(Detalleplanprocedimientos detalleplanprocedimientos) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Etapadeproduccion idetapaproduccion1Old = persistentDetalleplanprocedimientos.getIdetapaproduccion1();
            Etapadeproduccion idetapaproduccion1New = detalleplanprocedimientos.getIdetapaproduccion1();
            ...
            Planprocedimientos planprocedimientos1Old = persistentDetalleplanprocedimientos.getPlanprocedimientos1();
            Planprocedimientos planprocedimientos1New = detalleplanprocedimientos.getPlanprocedimientos1();
            ...
            if (idetapaproduccion1New != null) {
                ...
                detalleplanprocedimientos.setIdetapaproduccion1(idetapaproduccion1New);
            }
            ...
            if (planprocedimientos1New != null) {
                ...
                detalleplanprocedimientos.setPlanprocedimientos1(planprocedimientos1New);
            }
            ...
            if (idetapaproduccion1Old != null && !idetapaproduccion1Old.equals(idetapaproduccion1New)) {
                idetapaproduccion1Old.getDetalleplanprocedimientosSet().remove(detalleplanprocedimientos);
            ...
            if (idetapaproduccion1New != null && !idetapaproduccion1New.equals(idetapaproduccion1Old)) {
                idetapaproduccion1New.getDetalleplanprocedimientosSet().add(detalleplanprocedimientos);
            ...
            if (planprocedimientos1Old != null && !planprocedimientos1Old.equals(planprocedimientos1New)) {
                planprocedimientos1Old.getDetalleplanprocedimientosSet().remove(detalleplanprocedimientos);
            ...
            if (planprocedimientos1New != null && !planprocedimientos1New.equals(planprocedimientos1Old)) {
                planprocedimientos1New.getDetalleplanprocedimientosSet().add(detalleplanprocedimientos);
    ...
    public void destroy(DetalleplanprocedimientosPK id) throws NonexistentEntityException {
        ...
        try {
            ...
            Etapadeproduccion idetapaproduccion1 = detalleplanprocedimientos.getIdetapaproduccion1();
            if (idetapaproduccion1 != null) {
                idetapaproduccion1.getDetalleplanprocedimientosSet().remove(detalleplanprocedimientos);
                idetapaproduccion1 = em.merge(idetapaproduccion1);
            }
            Planprocedimientos planprocedimientos = detalleplanprocedimientos.getPlanprocedimientos();
            if (planprocedimientos != null) {
            ...
            Planprocedimientos planprocedimientos1 = detalleplanprocedimientos.getPlanprocedimientos1();
            if (planprocedimientos1 != null) {
                planprocedimientos1.getDetalleplanprocedimientosSet().remove(detalleplanprocedimientos);
                planprocedimientos1 = em.merge(planprocedimientos1);
            }
