...
public class Trabajotercerizado implements Serializable
{
	...
	public Trabajotercerizado(long idtrabajo ,long nrotrabajotercerizado ,Date fechapedidocotizacion ,Date fechaentregaestipulada ,Date fechaconfirmaciontrabajo ,Date fechacancelacion ,Date fechaentregareal ,Date fechaenvioaempresa ,String motivocancelacion ,long empresa ,int estado ,long pedido){
