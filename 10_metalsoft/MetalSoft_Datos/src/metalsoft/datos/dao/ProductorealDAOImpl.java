...
*/
	...
	public Productoreal findByPrimaryKey(long idproductoreal, Connection con) throws ProductorealException{
...
*/
	...
	protected Productoreal fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Productoreal dto = new Productoreal();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Productoreal dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Productoreal[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Productoreal ret[] = new Productoreal[ resultList.size() ];
