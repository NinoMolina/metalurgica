...
*/
	...
	public int update(RemitoPK remitopk, Remito remito, Connection con)throws RemitoException{
		...
		try
		{
			ps = con.prepareStatement("update REMITO set NROREMITO = ? , FECHAEMISION = ? , PEDIDO = ?  where idremito = ?");
				ps.setLong(1,remito.getNroremito());
				ps.setDate(2,remito.getFechaemision());
				ps.setLong(3,remito.getPedido());
				ps.setLong(4,remitopk.getIdremito());
...
*/
	...
	public int insert(Remito remito ,Connection con)throws RemitoException {
		...
		try
		{
			ps = con.prepareStatement("insert into REMITO( IDREMITO, NROREMITO, FECHAEMISION, PEDIDO) values (?, ?, ?, ?)");
				ps.setLong(1,remito.getIdremito());
				ps.setLong(2,remito.getNroremito());
				ps.setDate(3,remito.getFechaemision());
				ps.setLong(4,remito.getPedido());
...
*/
	...
	public Remito findByPrimaryKey(long idremito, Connection con) throws RemitoException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select idremito, nroremito, fechaemision, pedido from remito where idremito = ?";
...
*/
	...
	public Remito[] findByIdremito(long idremito, Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idremito, nroremito, fechaemision, pedido from remito where idremito = ? order by idremito";
			try {
...
*/
	...
	public Remito[] findByNroremito(long nroremito, Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idremito, nroremito, fechaemision, pedido from remito where nroremito = ? order by nroremito";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Remito[] findByFechaemision(Date fechaemision, Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idremito, nroremito, fechaemision, pedido from remito where fechaemision = ? order by fechaemision";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Remito[] findByPedido(long pedido, Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idremito, nroremito, fechaemision, pedido from remito where pedido = ? order by pedido";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Remito[] findAll( Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idremito, nroremito, fechaemision, pedido from remito";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Remito[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws RemitoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select idremito, nroremito, fechaemision, pedido from remito";
