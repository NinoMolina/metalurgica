...
* Date of code generation: Mon Jun 14 23:40:04 GYT 2010
*
...
*/
	...
	public int insert(Reclamoproveedor reclamoproveedor ,Connection con)throws ReclamoproveedorException {
		...
		try
		{
			ps = con.prepareStatement("insert into RECLAMOPROVEEDOR( IDRECLAMO, NRORECLAMO, TIPORECLAMO, MOTIVO, FECHARECLAMO, COMPRA) values (?, ?, ?, ?, ?, ?)");
				ps.setLong(1,reclamoproveedor.getIdreclamo());
				ps.setLong(2,reclamoproveedor.getNroreclamo());
				ps.setLong(3,reclamoproveedor.getTiporeclamo());
				ps.setString(4,reclamoproveedor.getMotivo());
				ps.setDate(5,reclamoproveedor.getFechareclamo());
				ps.setLong(6,reclamoproveedor.getCompra());
