...
*/
	...
	public int insert(Mantenimientopreventivo mantenimientopreventivo ,Connection con)throws MantenimientopreventivoException {
		...
		try
		{
			ps = con.prepareStatement("insert into MANTENIMIENTOPREVENTIVO( IDMANTENIMIENTOPREVENTIVO, FECHAMANTENIMIENTOPREVISTO, FECHAENVIOMANTENIMIENTO, HORAENVIOMANTENIMIENTO, PERIODO, NROMANTENIMIETNO, FECHAFINMANTENIMIENTOREAL, PROVEEDORMANTENIMIENTO, MAQUINA) values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,mantenimientopreventivo.getIdmantenimientopreventivo());
				ps.setDate(2,mantenimientopreventivo.getFechamantenimientoprevisto());
				ps.setDate(3,mantenimientopreventivo.getFechaenviomantenimiento());
				ps.setTime(4,mantenimientopreventivo.getHoraenviomantenimiento());
				ps.setString(5,mantenimientopreventivo.getPeriodo());
				ps.setLong(6,mantenimientopreventivo.getNromantenimietno());
				ps.setDate(7,mantenimientopreventivo.getFechafinmantenimientoreal());
				ps.setLong(8,mantenimientopreventivo.getProveedormantenimiento());
				ps.setLong(9,mantenimientopreventivo.getMaquina());
