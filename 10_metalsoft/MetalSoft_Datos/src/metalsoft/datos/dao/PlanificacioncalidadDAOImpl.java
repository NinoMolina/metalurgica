...
* Date of code generation: Mon Jun 14 23:39:33 GYT 2010
*
...
*/
	...
	public int insert(Planificacioncalidad planificacioncalidad ,Connection con)throws PlanificacioncalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into PLANIFICACIONCALIDAD( IDPLANIFICACION, NROPLANIFICACION, FECHACREACION, OBSERVACIONES, FECHAINICIOPREVISTA, FECHAFINPREVISTA, PEDIDO) values (?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,planificacioncalidad.getIdplanificacion());
				ps.setLong(2,planificacioncalidad.getNroplanificacion());
				ps.setDate(3,planificacioncalidad.getFechacreacion());
				ps.setString(4,planificacioncalidad.getObservaciones());
				ps.setDate(5,planificacioncalidad.getFechainicioprevista());
				ps.setDate(6,planificacioncalidad.getFechafinprevista());
				ps.setLong(7,planificacioncalidad.getPedido());
...
*/
	...
	public Planificacioncalidad findByPrimaryKey(long idplanificacion, Connection con) throws PlanificacioncalidadException{
...
*/
	...
	protected Planificacioncalidad fetchSingleResult(ResultSet rs) throws SQLException
	{
			if (rs.next()) {
					Planificacioncalidad dto = new Planificacioncalidad();
					populateVO( dto, rs);
				return dto;
			} else {
				return null;
...
*/
	...
	protected void populateVO(Planificacioncalidad dto, ResultSet rs) throws SQLException
	{
...
*/
	...
	protected Planificacioncalidad[]  fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Planificacioncalidad ret[] = new Planificacioncalidad[ resultList.size() ];
