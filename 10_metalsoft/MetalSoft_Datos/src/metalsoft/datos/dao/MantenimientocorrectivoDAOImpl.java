...
*/
	...
	public int insert(Mantenimientocorrectivo mantenimientocorrectivo ,Connection con)throws MantenimientocorrectivoException {
		...
		try
		{
			ps = con.prepareStatement("insert into MANTENIMIENTOCORRECTIVO( IDMANTENIMIENTOCORRECTIVO, FECHAENVIOMANTENIMIENTO, HORAENVIOMANTENIMIENTO, NROMANTENIMIENTOCORRECTIVO, EMPLEADO, NROCOMPROBANTEARREGLO, PROVEEDORMANTENIMIENTO, FECHAFINMANTENIMIENTOREAL, MAQUINA) values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,mantenimientocorrectivo.getIdmantenimientocorrectivo());
				ps.setDate(2,mantenimientocorrectivo.getFechaenviomantenimiento());
				ps.setTime(3,mantenimientocorrectivo.getHoraenviomantenimiento());
				ps.setLong(4,mantenimientocorrectivo.getNromantenimientocorrectivo());
				ps.setLong(5,mantenimientocorrectivo.getEmpleado());
				ps.setLong(6,mantenimientocorrectivo.getNrocomprobantearreglo());
				ps.setLong(7,mantenimientocorrectivo.getProveedormantenimiento());
				ps.setDate(8,mantenimientocorrectivo.getFechafinmantenimientoreal());
				ps.setLong(9,mantenimientocorrectivo.getMaquina());
