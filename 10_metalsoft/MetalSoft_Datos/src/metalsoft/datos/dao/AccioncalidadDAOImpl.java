...
*/
	...
	public int insert(Accioncalidad accioncalidad ,Connection con)throws AccioncalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into ACCIONCALIDAD( IDACCIONCALIDAD, NOMBRE, DESCRIPCION) values (?, ?, ?)");
				ps.setLong(1,accioncalidad.getIdaccioncalidad());
				ps.setString(2,accioncalidad.getNombre());
				ps.setString(3,accioncalidad.getDescripcion());
