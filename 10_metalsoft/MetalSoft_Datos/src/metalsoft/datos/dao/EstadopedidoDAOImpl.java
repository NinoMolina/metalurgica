...
*/
	...
	public int insert(Estadopedido estadopedido ,Connection con)throws EstadopedidoException {
		...
		try
		{
			ps = con.prepareStatement("insert into ESTADOPEDIDO( IDESTADO, NOMBRE, DESCRIPCION) values (?, ?, ?)");
				ps.setLong(1,estadopedido.getIdestado());
				ps.setString(2,estadopedido.getNombre());
				ps.setString(3,estadopedido.getDescripcion());
