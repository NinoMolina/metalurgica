...
*/
	...
	public int insert(Etapadeproduccion etapadeproduccion ,Connection con)throws EtapadeproduccionException {
		...
		try
		{
			ps = con.prepareStatement("insert into ETAPADEPRODUCCION( IDETAPAPRODUCCION, NROETAPAPRODUCCION, NOMBRE, HORASMAQUINA, HORASHOMBRE, MAQUINA, DURACIONESTIMADA, FECHACREACION) values (?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,etapadeproduccion.getIdetapaproduccion());
				ps.setLong(2,etapadeproduccion.getNroetapaproduccion());
				ps.setString(3,etapadeproduccion.getNombre());
				ps.setTime(4,etapadeproduccion.getHorasmaquina());
				ps.setTime(5,etapadeproduccion.getHorashombre());
				ps.setLong(6,etapadeproduccion.getMaquina());
				ps.setTime(7,etapadeproduccion.getDuracionestimada());
				ps.setDate(8,etapadeproduccion.getFechacreacion());
