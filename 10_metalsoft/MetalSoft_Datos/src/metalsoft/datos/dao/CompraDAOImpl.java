...
*/
	...
	public int insert(Compra compra ,Connection con)throws CompraException {
		...
		try
		{
			ps = con.prepareStatement("insert into COMPRA( IDCOMPRA, NROCOMPRA, FECHACOMPRA, VIGENCIA, DOCUMENTOREMITO, PRECIOTOTAL, ESTADO, MOTIVO, PROVEEDOR) values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,compra.getIdcompra());
				ps.setLong(2,compra.getNrocompra());
				ps.setDate(3,compra.getFechacompra());
				ps.setDate(4,compra.getVigencia());
				ps.setLong(5,compra.getDocumentoremito());
				ps.setDouble(6,compra.getPreciototal());
				ps.setLong(7,compra.getEstado());
				ps.setString(8,compra.getMotivo());
				ps.setLong(9,compra.getProveedor());
