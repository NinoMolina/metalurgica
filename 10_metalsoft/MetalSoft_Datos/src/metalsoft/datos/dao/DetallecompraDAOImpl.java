...
*/
	...
	public int insert(Detallecompra detallecompra ,Connection con)throws DetallecompraException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLECOMPRA( IDDETALLE, IDCOMPRA, CANTIDAD, MATERIAPRIMA, PRECIOHISTORICO, FECHARECEPCIONPARCIAL, ESTADO) values (?, ?, ?, ?, ?, ?, ?)");
				...
				ps.setLong(7,detallecompra.getEstado());
