...
*/
	...
	public int insert(Detalleplanificacioncalidad detalleplanificacioncalidad ,Connection con)throws DetalleplanificacioncalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLEPLANIFICACIONCALIDAD( IDDETALLE, IDPLANIFICACIONCALIDAD, IDDETALLEEJECUCIONPLANIFICACIONCALIDAD, IDEJECUCIONPLANIFICACIONCALIDAD, FECHAINICIOPLAN, FECHAFINPLAN, HORAINICIOPLAN, HORAFINPLAN, PROCESOCALIDAD, PIEZA) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detalleplanificacioncalidad.getIddetalle());
				ps.setLong(2,detalleplanificacioncalidad.getIdplanificacioncalidad());
				ps.setLong(3,detalleplanificacioncalidad.getIddetalleejecucionplanificacioncalidad());
				ps.setLong(4,detalleplanificacioncalidad.getIdejecucionplanificacioncalidad());
				ps.setDate(5,detalleplanificacioncalidad.getFechainicioplan());
				ps.setDate(6,detalleplanificacioncalidad.getFechafinplan());
				ps.setTime(7,detalleplanificacioncalidad.getHorainicioplan());
				ps.setTime(8,detalleplanificacioncalidad.getHorafinplan());
				ps.setLong(9,detalleplanificacioncalidad.getProcesocalidad());
				ps.setLong(10,detalleplanificacioncalidad.getPieza());
