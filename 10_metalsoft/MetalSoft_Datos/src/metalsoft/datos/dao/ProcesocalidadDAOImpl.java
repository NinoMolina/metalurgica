...
*/
	...
	public int insert(Procesocalidad procesocalidad ,Connection con)throws ProcesocalidadException {
		...
		try
		{
			ps = con.prepareStatement("insert into PROCESOCALIDAD( IDPROCESOCALIDAD, NOMBRE, NROPROCESO, ESPECIFICACION, TOLERANCIA, DESCRIPCION, DURACIONESTIMADA, FECHACREACION, HERRAMIENTA, ACCIONCALIDAD) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,procesocalidad.getIdprocesocalidad());
				ps.setString(2,procesocalidad.getNombre());
				ps.setLong(3,procesocalidad.getNroproceso());
				ps.setString(4,procesocalidad.getEspecificacion());
				ps.setString(5,procesocalidad.getTolerancia());
				ps.setString(6,procesocalidad.getDescripcion());
				ps.setTime(7,procesocalidad.getDuracionestimada());
				ps.setDate(8,procesocalidad.getFechacreacion());
				ps.setString(9,procesocalidad.getHerramienta());
				ps.setLong(10,procesocalidad.getAccioncalidad());
