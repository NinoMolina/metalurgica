...
*/
	...
	public int insert(Detallaplanificacionproduccion detallaplanificacionproduccion ,Connection con)throws DetallaplanificacionproduccionException {
		...
		try
		{
			ps = con.prepareStatement("insert into DETALLAPLANIFICACIONPRODUCCION( IDDETALLE, IDPLANIFICACIONPRODUCCION, IDDETALLEEJECUCIONPLANIFICACION, IDEJECUCIONPLANIFICACIONPRODUCCION, PIEZA, EMPLEADO, FECHAINICIO, HORAINICIO, FECHAFIN, HORAFIN) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,detallaplanificacionproduccion.getIddetalle());
				ps.setLong(2,detallaplanificacionproduccion.getIdplanificacionproduccion());
				ps.setLong(3,detallaplanificacionproduccion.getIddetalleejecucionplanificacion());
				ps.setLong(4,detallaplanificacionproduccion.getIdejecucionplanificacionproduccion());
				ps.setLong(5,detallaplanificacionproduccion.getPieza());
				ps.setLong(6,detallaplanificacionproduccion.getEmpleado());
				ps.setDate(7,detallaplanificacionproduccion.getFechainicio());
				ps.setTime(8,detallaplanificacionproduccion.getHorainicio());
				ps.setDate(9,detallaplanificacionproduccion.getFechafin());
				ps.setTime(10,detallaplanificacionproduccion.getHorafin());
