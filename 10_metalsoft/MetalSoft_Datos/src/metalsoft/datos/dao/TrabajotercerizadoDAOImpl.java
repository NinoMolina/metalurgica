...
*/
	...
	public int insert(Trabajotercerizado trabajotercerizado ,Connection con)throws TrabajotercerizadoException {
		...
		try
		{
			ps = con.prepareStatement("insert into TRABAJOTERCERIZADO( IDTRABAJO, NROTRABAJOTERCERIZADO, FECHAPEDIDOCOTIZACION, FECHAENTREGAESTIPULADA, FECHACONFIRMACIONTRABAJO, FECHACANCELACION, FECHAENTREGAREAL, FECHAENVIOAEMPRESA, MOTIVOCANCELACION, EMPRESA, ESTADO, PEDIDO) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
				ps.setLong(1,trabajotercerizado.getIdtrabajo());
				ps.setLong(2,trabajotercerizado.getNrotrabajotercerizado());
				ps.setDate(3,trabajotercerizado.getFechapedidocotizacion());
				ps.setDate(4,trabajotercerizado.getFechaentregaestipulada());
				ps.setDate(5,trabajotercerizado.getFechaconfirmaciontrabajo());
				ps.setDate(6,trabajotercerizado.getFechacancelacion());
				ps.setDate(7,trabajotercerizado.getFechaentregareal());
				ps.setDate(8,trabajotercerizado.getFechaenvioaempresa());
				ps.setString(9,trabajotercerizado.getMotivocancelacion());
				ps.setLong(10,trabajotercerizado.getEmpresa());
				ps.setInt(11,trabajotercerizado.getEstado());
				ps.setLong(12,trabajotercerizado.getPedido());
