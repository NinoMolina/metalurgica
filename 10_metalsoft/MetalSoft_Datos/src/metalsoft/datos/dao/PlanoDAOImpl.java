...
*/
	...
	public int update(PlanoPK planopk, Plano plano, Connection con)throws PlanoException{
		...
		try
		{
			ps = con.prepareStatement("update PLANO set NROPLANO = ? , ESCALA = ? , IMAGEN = ? , PEDIDO = ?  where idplano = ?");
				ps.setLong(1,plano.getNroplano());
				ps.setInt(2,plano.getEscala());
				ps.setBytes(3,plano.getImagen());
				ps.setLong(4,plano.getPedido());
...
*/
	...
	public int insert(Plano plano ,Connection con)throws PlanoException {
		...
		try
		{
			ps = con.prepareStatement("insert into PLANO( IDPLANO, NROPLANO, ESCALA, IMAGEN, PEDIDO) values (?, ?, ?, ?, ?)");
				ps.setLong(1,plano.getIdplano());
				ps.setLong(2,plano.getNroplano());
				ps.setInt(3,plano.getEscala());
				ps.setBytes(4,plano.getImagen());
				ps.setLong(5,plano.getPedido());
...
*/
	...
	public Plano findByPrimaryKey(long idplano, Connection con) throws PlanoException{
		...
		ResultSet rs = null;
		try {
	  		final String SQLSTATEMENT = "Select idplano, nroplano, escala, imagen, pedido from plano where idplano = ?";
...
*/
	...
	public Plano[] findByIdplano(long idplano, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano where idplano = ? order by idplano";
			try {
...
*/
	...
	public Plano[] findByNroplano(long nroplano, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano where nroplano = ? order by nroplano";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Plano[] findByEscala(int escala, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano where escala = ? order by escala";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Plano[] findByImagen(byte[] imagen, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano where imagen = ? order by imagen";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Plano[] findByPedido(long pedido, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano where pedido = ? order by pedido";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
...
*/
	...
	public Plano[] findAll( Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_STATEMENT ="Select idplano, nroplano, escala, imagen, pedido from plano";
			try {
					stmt = con.prepareStatement(SQL_STATEMENT);
					rs = stmt.executeQuery();
					return fetchMultiResults(rs);
...
*/
	...
	public Plano[] findExecutingUserWhere(String whereClause, Object[] sqlParams, Connection con) throws PlanoException{
			PreparedStatement stmt = null;
			ResultSet rs = null;
			String SQL_SELECT ="Select idplano, nroplano, escala, imagen, pedido from plano";
...
*/
	...
	protected void populateVO(Plano dto, ResultSet rs) throws SQLException
	{
		 ...
		 dto.setImagen(rs.getBytes("imagen"));
