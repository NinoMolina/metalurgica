...
{
   public DetalleReclamoEmpresaMetalurgica theDetalleReclamoEmpresaMetalurgica[];
   
   /**
    * @roseuid 4C27ED2702F5
    */
   ...
   /**
    * @roseuid 4C17FEBD0032
    */
   public void conocerDetalleReclamoEmpresaMetalurgica() 
   {
