...
import metalsoft.datos.dbobject.Usuarioxrol;
...
public class GestorRolDB {
    ...
    public static metalsoft.negocio.adminusuarios.Rol[] parseToRol(metalsoft.datos.dbobject.Rol roldb[])
    {
    ...
    public Rol[] obtenerRoles(long idUsuario) {
        ...
        Usuarioxrol uxr[]=null;
        long idrol=-1;
        metalsoft.datos.dbobject.Rol roldb[];
        ...
        roldb=new metalsoft.datos.dbobject.Rol[1];
    ...
    public static Rol parseToRol(metalsoft.datos.dbobject.Rol rol) {
